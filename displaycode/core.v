...
module core(
  ...
  always @(posedge clock) begin
    ...
    4'h1: begin draw<=4'h1; if (done) count<=4'h2; end
    4'h2: begin draw<=4'h2; if (done) count<=4'h3; end
    4'h3: begin draw<=4'h3; if (done) count<=4'h4; end
    4'h4: begin draw<=4'h4; if (done) count<=4'h5; end
    4'h5: begin draw<=4'h5; end
